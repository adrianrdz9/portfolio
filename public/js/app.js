...
function setNavigationButtonActive(e) {
  ...
  navigationItems.forEach(function (navigationItem) {
    return navigationItem.classList.remove("active");
  });
...
function addPortfolioHover() {
  ...
  overlay === null || overlay === void 0 ? void 0 : overlay.addEventListener("mouseleave", function (e) {
    hidePortfolioButtons(e);
  });
  portfolioItems.forEach(function (portfolioItem) {
    portfolioItem.addEventListener("mouseenter", function (e) {
      showPortfolioButtons(e);
    });
  });
}
...
function showPortfolioButtons(e) {
  ...
  var overlay = document.querySelector('.project-overlay-content');
  overlay.innerHTML = "<a href=\"".concat(portfolioItem.dataset.projectDetails, "\" class=\"button button--primary button--small\">Read details</a>\n    <a href=\"").concat(portfolioItem.dataset.projectLink, "\" class=\"button button--primary button--ghost button--small\" target=\"_blank\">See project</a>");
  overlay.classList.add('visible');
  overlay.setAttribute('style', "position: absolute; top: ".concat(offsetTop, "px; left: ").concat(offsetLeft, "px; height: ").concat(height, "px; width: ").concat(width, "px"));
}
